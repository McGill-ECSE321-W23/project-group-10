...
public class SubWithoutAccountController {
    ...
    /** 
     * method to update the SubWithoutAccount linked to the licenseNumber
     * @author Mike
     * @param licenseNumber - the licenseNumber linked to the SubWithoutAccount
     * @return the updated SubWithoutAccount with 1 more nbrMonths as Dto
     */
    @PutMapping(value = { "/{id}", "/{id}/" })
	public SubWithoutAccountDto updateSubWithoutAccountDto(@RequestParam String licenseNumber) {
